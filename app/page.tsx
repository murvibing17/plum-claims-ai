...
/*
 * Internal claim-history fixture.
 * This represents historical claims retrieved from an internal claims source.
 * The fraud engine remains generic: it only receives calculated history counts.
 */
...
const claimHistory: ClaimHistoryRecord[] = [
  { claimId: "HIST-001", employeeId: "EMP008", treatmentDate: "2024-08-10" },
  { claimId: "HIST-002", employeeId: "EMP008", treatmentDate: "2024-08-10" },
  { claimId: "HIST-003", employeeId: "EMP008", treatmentDate: "2024-08-10" },
  { claimId: "HIST-004", employeeId: "EMP008", treatmentDate: "2024-08-05" },
  { claimId: "HIST-005", employeeId: "EMP008", treatmentDate: "2024-08-06" },
];

function getClaimHistorySignals(
  employeeId: string,
  treatmentDate: string
) {
...
export default function Home() {
  ...
  function buildClaimInput(
    ...
    return {
      ...
      /* Fraud history is sourced from the internal claim-history fixture. */
      ...getClaimHistorySignals(
        demo.employeeId,
        demo.treatmentDate
      ),
  ...
  function buildClaimInputFromForm(
    formValue: typeof emptyForm,
    demo?: DemoCase
  ): ClaimInput {
    const historySignals =
      getClaimHistorySignals(
        formValue.employeeId,
        formValue.treatmentDate
      );
    ...
    return {
      ...
      treatmentDate: formValue.treatmentDate,
      diagnosis: formValue.diagnosis,
      hospitalName: formValue.hospitalName,
      hasPreAuth: formValue.hasPreAuth,
      sameDayClaimsBefore:
        historySignals.sameDayClaimsBefore,
      monthlyClaimsBefore:
        historySignals.monthlyClaimsBefore,
      ytdClaimsAmount:
        Number(formValue.ytdClaimsAmount),
      simulateComponentFailure:
